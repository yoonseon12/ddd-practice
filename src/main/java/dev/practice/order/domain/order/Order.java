...
public class Order extends AbstractEntity {
	...
	public Order(
		...
		validateOrder(userId, payMethod, deliveryFragment);
	...
	private void validateOrder(Long userId, String payMethod, DeliveryFragment deliveryFragment) {
		if (userId == null)
			throw new InvalidParamException("Order.userId");
		if (StringUtils.isEmpty(payMethod))
			throw new InvalidParamException("Order.payMethod");
		if (deliveryFragment == null)
			throw new InvalidParamException("Order.deliveryFragment");
	}
